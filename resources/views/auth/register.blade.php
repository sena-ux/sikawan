            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 lg:space-x-4">
                    ...
                    <button onclick="window.location.href='{{ route('login') }}'"
                        class="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white 
           px-4 py-2 lg:px-6 lg:py-3 rounded-xl hover:from-blue-600 hover:to-purple-700 
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover fade-in">
                ...
                <div class="p-6 sm:p-8">
                    <form id="registrationForm" class="space-y-5" method="post" enctype="multipart/form-data"
                        action="{{ route('register.post') }}"><!-- Foto Profil Field (Optional) -->
                        @csrf
