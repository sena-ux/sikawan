...
@section('pageTitle', 'Jurnal Harian Overview')
@section('pageSubTitle', 'Menu untuk mengelola Data Jurnal Harian Pegawai')
@section('content')
                        ...
                        <table id="absensiDataTable" class="min-w-full divide-y divide-gray-200 hidden">
                            <thead class="bg-gradient-to-r from-purple-400 via-pink-300 to-purple-500 text-white">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left font-semibold">Hari/Tanggal</th>
                                    <th class="px-4 py-2 text-left font-semibold">Kegiatan</th>
                                    <th class="px-4 py-2 text-left font-semibold">Deskripsi</th>
                                    <th class="px-4 py-2 text-left font-semibold">Dokumentasi</th>
                                </tr>
                            </thead>
