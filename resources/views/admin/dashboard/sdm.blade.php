    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 card-hover">
            <div class="text-center">
                ...
                <h4 class="text-lg font-semibold text-gray-800 mb-2">Tambah Jurnal Harian</h4>
                <p class="text-gray-600 text-sm mb-4">Buat entri jurnal aktivitas baru</p>
                <button onclick="window.location='{{ route('main.jurnal') }}'"
                    class="w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition-colors duration-200">
                    Tambah Jurnal
                </button>
            </div>
        </div>
